package backend.MealPlan.model;
...
public class MealPlanModel {
    ...
    public MealPlanModel(String id, String title, String description, String contentURL, List<String> tags, String postOwnerID, String imageUrl) {
        this.id = id;
        this.title = title;
