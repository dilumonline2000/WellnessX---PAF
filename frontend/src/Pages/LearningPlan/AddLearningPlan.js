...
import './MediaStyles.css'; // Import the new media styles
...
function AddLearningPlan() {
  ...
  const handleImageChange = (e) => {
    ...
    setShowImageUploadInput(true); // Show the section when an image is selected
  };
        ...
        <div className="modern-card create-post-card">
          <form onSubmit={handleSubmit} className="modern-form">
            ...
            <div className="form-group">
              ...
              <small>Add at least 2 tags to categorize your workout plan</small>
            </div>
            ...
            <div className="form-group template-selection-section">
              ...
              {templateID && (
                <div className="selected-template-preview">
                  ...
                  {/* The template preview sections remain unchanged */}
                  {templateID === '1' && (
