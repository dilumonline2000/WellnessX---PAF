...
import { FaEnvelope, FaPhone, FaTools, FaBook, FaLightbulb, FaMedal, FaChevronRight, FaTrash } from 'react-icons/fa';
                    ...
                    <>
                        <header className="dashboard-header">
                            <div className="user-welcome">
                                ...
                                <p>Manage your Google-connected profile and activities</p>
                            </div>
                        </header>
